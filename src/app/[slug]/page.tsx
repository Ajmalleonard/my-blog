...
import TableOfContent from "../components/tableOfContent/table_of_contents";
import Link from "next/link";
import Simmilar from "../components/similar";

function SinglePost() {
  return (
    <section className="flex flex-col xl:max-container h-auto  ">
      <div className=" xl:px-20  w-full xl:max-container flex gap-4 justify-start items-center h-[140px] px-4 ">
        ...
        <h3 className="text-[20px] md:text-medium">BEST CSS TOOLS FOR 2024</h3>
      </div>
      <section className="w-full h-[1900px] xl:max-container bg-dark flex  justify-between xl:px-20 ">
